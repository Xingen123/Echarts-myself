<template>
  <div class="app" id="app">
    ...
    <el-row>
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="10" :xl="8" class="part">
        <router-view name="PartTwo" />
      </el-col>
      <el-col :xs="24" :sm="24" :md="7" :lg="8" :xl="11" class="part">
...
export default {
  ...
  data () {
    return {
      bannerXSSM: require("./assets/img/banner_640.jpg"),
      bannerMD: require("./assets/img/banner_1000.jpg"),
      bannerLGXL: require("./assets/img/banner.jpg"),
    };
  }
};
</script>
